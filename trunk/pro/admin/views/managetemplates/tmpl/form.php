    ...
    <fieldset class="adminform" style="position: relative;">
        ...
        <div id="main_styles_table">
	        ...
	        <tr>
	            ...
	            <td class="st_td">
	                <input class="text_area" type="text" name="name" id="name" size="60" maxlength="250" value="<?php echo $this->template->name;?>" />
	            </td>
	            <?php close_accordion();?>
	        </tr>
	        <?php 
	        	$styles_array = explode('|',$this->template->styles);
	        	$max = 0;
